...
#define NEOMUTT_TEST_LIST                                                      \
  ...
  NEOMUTT_TEST_ITEM(test_email_find_header)                                    \
  NEOMUTT_TEST_ITEM(test_email_add_header)                                     \
  NEOMUTT_TEST_ITEM(test_email_update_header)                                  \
  NEOMUTT_TEST_ITEM(test_email_set_header)                                     \
                                                                               \
  /* envelope */                                                               \
